...
- Ses altyapısı genişletildi: ALSA-lib, ALSA Utilities, libsndfile, PipeWire (`pw-cat` açık), Lua ve WirePlumber LFS rootfs'ye kuruldu; paket testleri geçti. Builder kernelindeki geçici `snd-aloop` ile ALSA PCM playback→capture roundtrip geçti (144000 kare, peak 12000, RMS 7046.61). Bu fiziksel hoparlör/mikrofon değildir. PipeWire/WirePlumber otomatik Loopback kaynağında sessiz kayıt verdi; PipeWire I/O ve gerçek aygıt doğrulaması açık.
