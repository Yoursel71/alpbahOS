...
- Grafik tabanı kesiti tamamlandı: libxml2 2.14.5, libdrm 2.4.125 ve Wayland 1.24.0 test/kurulum geçti. Mesa Wayland softpipe tabanıyla kuruldu. QtBase 6.9.2 `/opt/qt6` altına kuruldu; QtBase QImage ve QtDeclarative QQuickView offscreen smoke kontrolleri geçti. QtShaderTools kuruldu; QtDeclarative kurulum ve QML runtime doğrulaması geçti. QtWayland, Xwayland, KWin ve Plasma henüz kurulu değil.
