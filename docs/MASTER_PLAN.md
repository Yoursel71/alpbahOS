...
| M04 | Chroot ve nihai LFS temel sistemi | M02 kararları, M03 | Kısmi: Coreutils, Zlib, Gzip, Zstd, Xz, Bzip2, Lz4, File, Readline, M4, Diffutils ve Findutils için izole stage manifestleri/preflight kanıtı var; bazıları rootfs ile uyuşmuyor ve tam temel paket kapsamı yok. Findutils 4.10.0 testleri 313 PASS/74 SKIP/0 FAIL; smoke geçti, 6/144 kayıt eşleşti. Rootfs `alp` DB boş, base-package removal guard yok; kayıt eklemek güvenli değil. Hiçbir uyuşmayan stage birleştirilmedi. [Değerlendirme](verification/m04-base-ownership-assessment-2026-09-23.md). |
