...
- Nihai temel sistemde paket dosya sahipliği kaydı üretildiği doğrulanır; geçici DESTDIR manifestleri ve rootfs karşılaştırmaları tek başına sahiplik kaydı veya tarihsel kurulum kanıtı değildir.
