...
| M07 | Hazır masaüstü ve temel uygulama profili | M06 | P0 KWin unit/Wayland-only kapısı geçti; Gen2'de tty1 `admin` PAM/logind oturumu (`Seat=seat0`, `Active=yes`) doğrulandı. Gerçek Plasma, ayarlar ve dosya yöneticisi kanıtı hâlâ bekliyor. |
