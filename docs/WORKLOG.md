...
## 23 Eylül 2026 — QtBase XKB yapılandırma düzeltmesi (devam ediyor)
...
- QtBase kaynak arşivi daha önceki doğrulanmış SHA-256 `44be9c9ecfe04129c4dea0a7e1b36ad476c9cc07c292016ac98e7b41514f2440` ile kullanıldı. BLFS libxkbcommon 1.11.0 mevcutken ayrı `/sources/qtbase-build-m2` ağacı `FEATURE_xkbcommon=ON` ile yapılandırıldı; özet `xkbcommon=yes`, `xkbcommon-x11=no`. Full QtBase Ninja rebuild (`-j2`) devam ediyor; henüz kurulmadı ve KWin tekrar bağlanmadı.
