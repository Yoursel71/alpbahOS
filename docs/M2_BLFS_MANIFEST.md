...
- Mesa 25.1.8: MD5 `fe3eb39e8a3c6fbb36eb3da57be022e7`; Mako 1.3.10 ve PyYAML 6.0.2 Python bağımlılıkları kuruldu. X11 platformları olmadan Hyper-V yazılım yolu için `platforms=[]`, `gallium-drivers=softpipe`, `vulkan-drivers=[]`, `glx=disabled`, `llvm=disabled` build/install geçti. `libEGL`, GLES ve DRI software sürücüleri bulundu. Qt/KWin/Plasma sonraki kesit.
