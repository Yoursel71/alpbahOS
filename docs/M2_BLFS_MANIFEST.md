...
- Mesa kapısı: BLFS 12.4 Mesa 25.1.8 için Xorg Libraries, Mako 1.3.10 ve PyYAML 6.0.2 gerekiyor; LFS rootfs kontrolünde X11 pkg-config, Mako ve PyYAML yok. Bu bağımlılıklar tamamlanmadan Mesa/Plasma kurulumu yapılmayacak.
