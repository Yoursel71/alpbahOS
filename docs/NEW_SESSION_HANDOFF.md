...
- Resmî LFS 12.4-systemd Chapter 8 kapsamı 79 paket; repoda 26 stage manifesti (8,532 path) var. Man-pages 6.15 3,029/3,029 match; Iana-Etc'in `services` ve `protocols` dosyaları eşleşiyor, `/etc` metadata'sı uid 1001/0 farkı gösteriyor. Paket paket liste ve eşleşme durumu: `docs/verification/m04-lfs-12.4-package-coverage-2026-09-24.md`. Kalan 53 paket için aday kaynak arşivi var; checksum/build/test ayrı doğrulanmalı. Sıradaki paket Tcl 8.6.16 için isolated stage çalışması sürüyor; rootfs ve DB'ye merge yok.
