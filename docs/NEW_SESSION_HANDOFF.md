...
- Resmî LFS 12.4-systemd Chapter 8 kapsamı 79 paket; repoda 25 stage manifesti (8,433 path) var. Man-pages 6.15 3,029/3,029 match; Iana-Etc'in `services` ve `protocols` dosyaları eşleşiyor, `/etc` metadata'sı uid 1001/0 farkı gösteriyor. Paket paket liste ve eşleşme durumu: `docs/verification/m04-lfs-12.4-package-coverage-2026-09-24.md`. Kalan 54 paket için aday kaynak arşivi var; checksum/build/test ayrı doğrulanmalı. Sıradaki paket Flex 2.6.4 için isolated stage çalışması sürüyor; rootfs ve DB'ye merge yok.
