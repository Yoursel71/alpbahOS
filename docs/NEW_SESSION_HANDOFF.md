...
- M04 sahiplik çıkış koşulu açık: `/mnt/lfs/var/lib/alp/db.json` boş `packages`; `alp`'te base-package removal guard yok. Coreutils, Zlib, Gzip, Zstd, Xz, Bzip2, Lz4, File, Readline, M4, Diffutils, Findutils, Gawk ve Grep için izole stage manifestleri toparlandı; mevcut rootfs ile bazı stage'lerde fark var ve tam LFS taban kapsamı oluşmadı. Grep 3.12 testleri 368 PASS, 73 SKIP, 2 XFAIL, 0 FAIL; smoke geçti; 52/147 manifest girdisi eşleşti. Stage rootfs'e birleştirilmedi. Bunlar tarihsel sahipliğin yerine geçmez; dosya uid/gid'sinden tahmin etme veya stage'leri rootfs'e birleştirme. Değerlendirme: `docs/verification/m04-base-ownership-assessment-2026-09-23.md`.
