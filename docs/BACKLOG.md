...
| BLFS-01 | Codex | BOOT-01 | Ağ/ses/grafik/oturum bağımlılıkları | TLS/ses/renderer testleri | Ağ/TLS, PAM/logind, pkexec e2e, Mesa softpipe EGL readback, ALSA loopback ve PipeWire null-sink PCM graph testleri geçti. Fiziksel/ALSA-routed audio ve Wayland oturumu yok. BLFS-01 kısmi; QtBase build sürüyor |
...
| DESKTOP-01 | Codex | BLFS-01, UI/SHELL girdileri | LFS içinde Plasma oturumu | Temiz kullanıcı, düşük kaynak ölçümü | Başlamadı — QtBase build sürüyor; Wayland/Xorg oturumu katmanı bekliyor |
