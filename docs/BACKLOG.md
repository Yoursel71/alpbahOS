...
| BLFS-01 | Codex | BOOT-01 | Ağ/ses/grafik/oturum bağımlılıkları | TLS/ses/renderer testleri | Ağ/TLS, PAM/logind, Polkit ve ALSA/PipeWire build/test/install kesitleri geçti. p11-kit `test-path` SIGSEGV, Polkit dbusmock testi ve gerçek grafik/ses aygıtı açık; DRM/Mesa/Wayland sürüyor |
