...
| BLFS-01 | Codex | BOOT-01 | Ağ/ses/grafik/oturum bağımlılıkları | TLS/ses/renderer testleri | Ağ/TLS geçti; D-Bus mevcut; Linux-PAM + systemd/logind geçti; GLib/Duktape/Polkit kuruldu. p11-kit `test-path` SIGSEGV ve Polkit test eksikliği açık; grafik/ses sürüyor |
