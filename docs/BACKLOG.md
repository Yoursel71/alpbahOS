...
| BOOT-01 | Codex | BUILD-03 | Gen2 ve Gen1 boot | Güncel hedef kernel ile BIOS/UEFI giriş/ağ/reboot | **Kısmi:** M1 Gen1 DHCP/ping/reboot geçti; M2 hedef kernel Gen2/UEFI’de yeni rootfs v3 imajıyla boot etti, DHCP `172.28.171.21/20`, SSH key-only ve boş `systemctl --failed` doğrulandı. Yeni v3 için kontrollü reboot tekrarı bekliyor. |
