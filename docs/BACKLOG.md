...
| BLFS-01 | Codex | BOOT-01 | Ağ/ses/grafik/oturum bağımlılıkları | TLS/ses/renderer testleri | Ağ/TLS geçti; D-Bus mevcut; Linux-PAM 1.7.1 kuruldu ve systemd 257.8 PAM/logind rebuild geçti. p11-kit `test-path` SIGSEGV açık; polkit/grafik/ses sürüyor |
