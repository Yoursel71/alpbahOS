...
| BLFS-01 | Codex | BOOT-01 | Ağ/ses/grafik/oturum bağımlılıkları | TLS/ses/renderer testleri | Ağ/TLS, PAM/logind, Polkit, ALSA/PipeWire ve libxml2/libdrm/Wayland kesitleri geçti. p11-kit `test-path` SIGSEGV, Polkit dbusmock ve gerçek aygıt testleri açık; Mesa/Qt/Plasma sürüyor |
